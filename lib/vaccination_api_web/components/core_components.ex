defmodule VaccinationApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VaccinationApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VaccinationApiWeb.Gettext, "errors", msg, opts)
    end
  end
